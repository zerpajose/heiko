...
<main>
  ...
  {:else}
    <div class="grid">
      <div 
        class="card {selectedRate === 'PRIMARY' ? 'selected' : ''}"
      ...
      >
        ...
        <p>{$rates.data.getCountryConversions.conversionRates.find(rate => rate.type === 'PRIMARY')?.baseValue || 'N/A'}</p>
      </div>
      
      <div 
        class="card {selectedRate === 'SECONDARY' ? 'selected' : ''}"
      ...
      >
        ...
        <p>{$rates.data.getCountryConversions.conversionRates.find(rate => rate.type === 'SECONDARY')?.baseValue || 'N/A'}</p>
      </div>
      
      <div 
        class="card {selectedRate === 'AVERAGE' ? 'selected' : ''}"
